...
| Column Selection (small screens only)       |                                                                        On small screens (typically phones), only 4 columns can be shown at a time. An extra dropdown should be shown for users to change which columns they are viewing, from the default.<br><br>When users remove and add columns using the checkboxes in this dropdown, the visible columns should be updated accordingly in the table                                                                        | N/A          |            | N/A           | N/A             | &check;          |
...
| Change Password                             |                                                                                                            Users can change their password by entering their current password, and a new password twice, that meets the minimum requirements.<br><br>An error will appear if the new password does not meet those requirements, or the current password is incorrect                                                                                                             | &check;      | &check;    | &check;       |                 | &check;          |
